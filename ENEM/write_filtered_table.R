...
table <- fread("MICRODADOS/microdados_enem_2019/DADOS/MICRODADOS_ENEM_2019.csv")
...
write.csv(table_filtered, file = paste0("MICRODADOS/table_filtered.csv"), row.names = FALSE)
